...
export const DEFAULT_PROMPT_POLICY_TEMPLATE = {
  ...
  mypInstructions: joinInstructionLines([
    ...
    "Learning objective: one sentence stating the transferable learning move or understanding the learner should take away.",
    ...
    "Key / related concepts: give one key concept and one or two related concepts in compact IB-friendly wording.",
  ...
  dpInstructions: joinInstructionLines([
    ...
    "Learning objective: one sentence stating the analytical habit, evaluative lens, or reasoning move the learner should practice.",
    ...
    "Method focus: briefly name the disciplinary or analytical method the learner should notice, such as causation, confounding variables, comparison, or evidence quality.",
    "TOK link: one sentence connecting the issue to a knowledge question about evidence, interpretation, certainty, or perspective.",
    "TOK / essay prompt should invite evaluation, justification, and consideration of evidence quality rather than simple recall.",
    "Researchable question: one concise question that could guide deeper investigation or extended writing.",
