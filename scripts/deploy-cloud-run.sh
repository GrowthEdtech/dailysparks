...
if [[ -n "${NOTION_OAUTH_CLIENT_ID:-}" ]]; then
  ENV_VARS="${ENV_VARS},NOTION_OAUTH_CLIENT_ID=${NOTION_OAUTH_CLIENT_ID}"
fi

if [[ -n "${NOTION_OAUTH_REDIRECT_URI:-}" ]]; then
  ENV_VARS="${ENV_VARS},NOTION_OAUTH_REDIRECT_URI=${NOTION_OAUTH_REDIRECT_URI}"
fi
